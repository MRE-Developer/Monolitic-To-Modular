...
@section('scripts')
    @if ($edit)
        {!! JsValidator::formRequest('RoleModule\Http\Requests\Role\UpdateRoleRequest', '#role-form') !!}
    @else
        {!! JsValidator::formRequest('RoleModule\Http\Requests\Role\CreateRoleRequest', '#role-form') !!}
    @endif
@stop
